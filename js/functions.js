...
(function($){
	...
	SEMICOLON.initialize = {
		...
		init: function(){
			...
			SEMICOLON.initialize.goToRequestAQuoteSection();
		},
		...
		goToRequestAQuoteSection: function () {
		    var el = $('#request-a-quote');
		    var elementScrollSpeed = el.attr('data-speed'),
				elementScrollEasing = el.attr('data-easing');
		...
		twitterFeed: function(){
			...
			if( $twitterFeedEl.length > 0 ){
				$twitterFeedEl.each(function() {
					...
					if( !twitterFeedLoader ) { twitterFeedLoader = 'include/twitter/tweets.html'; }
